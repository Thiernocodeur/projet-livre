...
//             const livreId = e.target.parentElement.dataset.id;
...
//             li.innerHTML = `
//                 <span class="${livre.lu ? 'livre-lu' : ''}">${livre.titre} - ${livre.auteur}</span>
//                 <span>&nbsp;&nbsp;</span>
//                 <button class="supprimer" data-id="${livre.id}">Supprimer</button>
//                 <span>&nbsp;&nbsp;</span>
//                 <button class="marquer" data-id="${livre.id}">${livre.lu ? 'Non Lu' : 'Lu'}</button>
//             `;
